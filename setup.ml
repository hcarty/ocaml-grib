...
(* OASIS_START *)
(* DO NOT EDIT (digest: 90c982074483d3fd1afbb4f4e54cd8a2) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          description =
            Some
              [
                 OASISText.Para
                   "Access GRIB1 and GRIB2 data, a format commonly used in meteorology."
              ];
          categories = [];
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "grib";
                           FindlibPackage ("oUnit", None);
                           InternalLibrary "test_components"
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\152\022d\218\006?\148\163\234\017\228`\b\220qT";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
