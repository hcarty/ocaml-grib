...
(* OASIS_START *)
(* DO NOT EDIT (digest: a39c79be2a94a04f3f37fc27fcd71b53) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/hcarty/ocaml-grib";
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "t";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "grib"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                   ...
                   {exec_custom = true; exec_main_is = "gc_test.ml"});
               Executable
                 ({
                     cs_name = "get_set";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = true; exec_main_is = "get_set.ml"});
               Executable
                 ({
                     cs_name = "message_test";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = true; exec_main_is = "message_test.ml"});
               Executable
                 ({
                     cs_name = "handle_test";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = true; exec_main_is = "handle_test.ml"});
               Executable
                 ({
                     cs_name = "index_test";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = true; exec_main_is = "index_test.ml"});
               Executable
                 ({
                     cs_name = "nearest_test";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = true; exec_main_is = "nearest_test.ml"});
               Executable
                 ({
                     cs_name = "g2clib_test";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = true; exec_main_is = "g2clib_test.ml"});
               SrcRepo
                 ({
                     cs_name = "master";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "https://github.com/hcarty/ocaml-grib.git";
                      src_repo_browser =
                        Some "https://github.com/hcarty/ocaml-grib";
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\198P\022+.\238h\226\157\204\248\031 g\195\127";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
